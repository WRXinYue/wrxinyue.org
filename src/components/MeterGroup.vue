...
<template>
  <div :class="cx('root')" role="meter" :aria-valuemin="min" :aria-valuemax="max" :aria-valuenow="totalPercent" v-bind="ptm('root')" data-pc-name="metergroup">
    <slot v-if="labelPosition === 'start'" name="label" :value="value" :total-percent="totalPercent" :percentages="percentages">
      <MeterGroupLabel :value="value" :label-position="labelPosition" :label-orientation="labelOrientation" :unstyled="unstyled" :pt="pt" />
    </slot>
    <slot name="start" :value="value" :total-percent="totalPercent" :percentages="percentages" />
    ...
    <slot name="end" :value="value" :total-percent="totalPercent" :percentages="percentages" />
    <slot v-if="labelPosition === 'end'" name="label" :value="value" :total-percent="totalPercent" :percentages="percentages">
      <MeterGroupLabel :value="value" :label-position="labelPosition" :label-orientation="labelOrientation" :unstyled="unstyled" :pt="pt" />
    </slot>
  </div>
</template>
