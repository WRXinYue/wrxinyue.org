<template>
  <div class="page overflow-auto z-1 h-auto">
    <header
      class="gsap_header relative flex px-70px justify-center flex-items-center w-full h-100vh"
    >
      <h1 class="gasp_title my-element">
        <span class="title_paralax">WRXinYue's</span
        ><span class="theme-stroke">Home</span>
      </h1>
      <div
        class="gsap_header__img absolute h-full w-full top-0 overflow-hidden"
      >
        <img
          class="object-cover block bg-cover"
          src="https://w.wallhaven.cc/full/3l/wallhaven-3lgk6y.png"
          alt="1"
        />
      </div>
    ...
    <main class="container">
      <section class="about">
        <div class="about__wrapp flex justify-between">
          <div class="about__img h-auto theme-about">
            <img
              src="https://w.wallhaven.cc/full/q2/wallhaven-q21ezq.jpg"
              alt="2"
            />
          </div>
        ...
        <div class="content">
          ...
          <ul class="skills__list">
            <li class="skills__item" v-for="skill in skills">
              <span class="skills__num" :data-speed="skill.speed">{{
                skill.id
              }}</span>
      ...
      <section class="work">
        ...
        <div class="work__wrapp">
          <div
            class="work__item"
            :data-speed="project.workItemSpeed"
            v-for="project in projects"
          >
            <span
              class="work__item-num"
              :data-speed="project.workItemNumSpeed"
              >{{ project.id }}</span
            >
